<%@ Page Title="Address Detail" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AddressDetail.aspx.cs" Inherits="Registration_AddressDetail" Theme="SkinFile"%>
    ...
    <table class="style1">
        ...
        <tr>
            <td class="style2">
                Name:</td>
            <td class="style6">
                <asp:TextBox ID="txtfnm" runat="server" Width="180px" Enabled="False" 
        ...
        <tr>
            <td class="style3" colspan="2">
                ...
                <asp:HyperLink ID="HyperLink11" runat="server" 
                    NavigateUrl="~/Admin/PersonalInfo.aspx">Personal Information</asp:HyperLink>
                </span>?</td>
        </tr>
        <tr>
            <td class="style3" colspan="2">
