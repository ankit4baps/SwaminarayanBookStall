<%@ Page Title="Satsang Darshan" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SatsangDarshan.aspx.cs" Inherits="Publication_SatsangDarshan" Theme="SkinFile"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        DataSourceID="SqlDataSource1" PageSize="2" ShowHeader="False" Width="100%" 
                        ...
                        <tr>
                            <td class="style4" rowspan="6">
                                <asp:Image ID="Image1" runat="server" Height="157px" 
                                    ImageUrl='<%# Bind("photo", "~/Image/{0}") %>' Width="134px" />
                            </td>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="S%" Name="book_id" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
