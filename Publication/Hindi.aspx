<%@ Page Title="Hindi Publication" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Hindi.aspx.cs" Inherits="Publication_Hindi" Theme="SkinFile"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="H" Name="book_id" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
