<%@ Page Title="Personal Information" Language="C#" MasterPageFile="~/custMaster.master" AutoEventWireup="true" CodeFile="PersonalInfo.aspx.cs" Inherits="Registration_PersonalInfo" Theme="SkinFile"%>
    ...
    <table class="style1">
        ...
        <tr>
            <td class="style2">
                Gender:</td>
            <td>
                <asp:RadioButton ID="RadioButton1" runat="server" Font-Bold="False" 
                    GroupName="g" Text="Male" ValidationGroup="a" />
&nbsp;&nbsp;&nbsp;
                <asp:RadioButton ID="RadioButton2" runat="server" Font-Bold="False" 
                    GroupName="g" Text="Female" ValidationGroup="a" />
            </td>
        </tr>
        <tr>
            <td class="style2">
        ...
        <tr>
            ...
            <td class="style9">
                ...
                &nbsp;(eg.2652791245)<asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" 
