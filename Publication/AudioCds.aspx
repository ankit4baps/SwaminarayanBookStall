<%@ Page Title="Audio CD's" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="AudioCds.aspx.cs" Inherits="Publication_AudioCds" Theme="SkinFile"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                        ...
                        <tr>
                            <td class="style4" rowspan="6">
                                <asp:Image ID="Image1" runat="server" Height="162px" 
                                    ImageUrl='<%# Eval("photo", "~/Image/{0}") %>' Width="136px" />
                            </td>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="A%" Name="book_id" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
