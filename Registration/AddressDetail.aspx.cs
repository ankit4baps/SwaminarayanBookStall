...
public partial class Registration_AddressDetail : System.Web.UI.Page
{
    ...
    protected void btnuser_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            if (Session["txtcity"] == null || Session["txtcity"] == "")
            {
                cmd = new SqlCommand("insert into addDetail values('" + txtemail.Text + "','" + txtfnm.Text + "','" + txtstadd.Text + "','" + txtcity.Text + "','" + txtta.Text + "','" + txtdist.Text + "','" + txtstate.Text + "','" + txtco.Text + "','" + txtpin.Text + "')", cn);
            }
            else
            {
