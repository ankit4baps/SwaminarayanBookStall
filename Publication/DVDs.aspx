<%@ Page Title="DVD's" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DVDs.aspx.cs" Inherits="Publication_DVDs" Theme="SkinFile"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="D%" Name="book_id" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
