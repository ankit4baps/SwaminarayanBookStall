<%@ Page Title="Marathi Publication" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Marathi.aspx.cs" Inherits="Publication_Marathi" Theme="SkinFile"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
        ...
        <Columns>
            <asp:TemplateField>
                <ItemTemplate>
                    <table class="style1" style="border: thin solid #FFFFFF; background-color: #FFFF99;">
                        <tr>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="M" Name="book_id" Type="String" />
        </SelectParameters>
    </asp:SqlDataSource>
</asp:Content>
