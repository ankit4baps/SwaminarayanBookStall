    ...
    protected void btninfo_Click(object sender, EventArgs e)
    {
        cn.Open();
         try
         {
            ...
            if (Session["txtfnm"] == null || Session["txtfnm"] == "")
            {
                cmd = new SqlCommand("insert into personalInfo values('" + txtemail.Text + "','" + txtfnm.Text + "','" + txtlnm.Text + "','" + gn + "','" + txtbd.Text + "'," + mno + "," + lno + ")", cn);
            }
            else
            {
